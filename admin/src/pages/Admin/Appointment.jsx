  ...
  return (
    <div className="w-full max-w-6xl m-5">
      ...
      {appointments.map((item,index)=>(
        <div 
        className="flex flex-wrap justify-between mx-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50"
        key={index}>
